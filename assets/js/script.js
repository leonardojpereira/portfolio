...
document.onmouseover = function (element) {
    ...
    let levelBar = document.querySelector('.level-bar-color');
    if (element.target.classList.contains('html')) {
        ...
        <span>95%</span>
        <div class="level-bar">
            <div class="level-bar-color html-level"></div>
        </div>`;
    }
        ...
        <span>90%</span>
        <div class="level-bar">
            <div class="level-bar-color css-level"></div>
        </div>`;
    }
        ...
        <span>75%</span>
        <div class="level-bar">
            <div class="level-bar-color js-level"></div>
        </div>`;
    }
        ...
        <span>70%</span>
        <div class="level-bar">
            <div class="level-bar-color git-level"></div>
        </div>`;
    }
        ...
        <span>50%</span>
        <div class="level-bar">
            <div class="level-bar-color firebase-level"></div>
        </div>`;
    }
        ...
        <span>65%</span>
        <div class="level-bar">
            <div class="level-bar-color bs-level"></div>
        </div>`;
    }
        ...
        <span>40%</span>
        <div class="level-bar">
            <div class="level-bar-color java-level"></div>
            <div class="level-bar-color java-level-twin"></div>
        </div>`;
